<template>
  <div
    class="flex items-center h-[40px] cursor-pointer border hover:p-px hover:border-0 border-black/12 hover:bg-white rounded-[10px]"
  >
    <div class="flex-none flex items-center justify-center h-[30px] w-[30px] ml-[5px] mr-[8px]">
      <svg
        width="20"
        height="20"
        viewBox="0 0 30 30"
    ...
    <div class="flex-initial flex items-center overflow-hidden w-full mr-[8px]">
      <p
        class="font-roboto text-[13px] leading-[15px] truncate text-[#606061]"
      >
        {{ title }}
      </p>
    </div>
