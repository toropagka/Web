<template>
  ...
  >
    ...
    <p class="font-bold">
      Очередь - функция тарифа "Бизнес" и "Альфа"
    </p>
    ...
    <a
      ...
      class="mt-5 w-[238px] flex justify-center items-center cursor-pointer bg-[#F2B679] text-[#2E2E2E] text-lg px-10 py-1 rounded-md hover:bg-slate-200 hover:text-[#422b14]"
    >
      Купить
    </a>
  </div>
