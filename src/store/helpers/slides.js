...
export default [
  ...
  },
  {
    ...
    <a class="justify-center cursor-pointer bg-orange-400 text-white mt-2 text-lg p-2 rounded-md hover:bg-slate-200 hover:text-orange-400" href="/settings">Загрузить</a>
    `,
    video: ''
  },
  {
