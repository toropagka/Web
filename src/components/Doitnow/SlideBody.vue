      ...
      <div class="flex flex-col items-center">
        ...
        <div>
          <article class="font-[400] text-[18px] leading-[29px] text-left w-full text-[#4C4C4D] mb-[35px] pl-0">
            ...
            <p class="mt-1 mb-1">
              ЛидерТаск сам будет следить за выполнением задачи вашим сотрудником и в случае простоя - звонить и писать сообщения сотруднику, если сотрудник не будет отвечать - исполнитель получит звонок и сообщение.
            </p>
            <p class="mt-1 mb-1">
