    ...
    <div class="flex flex-col gap-[12px]">
      ...
      >
        ...
        <contenteditable
          ...
          class="self-center w-[280px] font-roboto font-medium text-[13px] leading-[15px]"
      ...
      >
        ...
        <contenteditable
          ...
          tag="div"
          placeholder="Добавить"
          class="self-center w-[280px] font-roboto font-medium text-[13px] leading-[15px] text-[#4c4c4d]"
